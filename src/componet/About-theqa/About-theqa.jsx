...
const AboutTheqa = ({ language }) => {
  return (
    <div className={`about-theqa-container ${language ? 'rtl' : 'ltr'}`}>
      ...
      <div className="about-theqa-content">
        <div className="about-theqa-text">
          ...
          <p className="main-description">
            {language 
              ? 'هدفنا هو تمكينك من الاستثمار بثقة في الأسواق العالمية وبناء ثروة مستدامة على المدى الطويل. ابدأ معنا الآن لتحقيق النجاح المالي الذي تطمح إليه!'
