...
import './Estatetplan.css';
import temp2 from '../../../public/IMG/temp2.png';
import { FaWhatsapp } from "react-icons/fa";


export const Estateplan = () => {
    const handleWhatsAppClick = () => {
        window.open(`https://wa.me/98049957`, '_blank');
      };

    return(
    <div className={`Estatetplan-container ${language ? 'rtl' : 'ltr'}`}>
        <div className='Estatetplan-banner'>
        ...
        <div className='Estatetplan-content'>
            ...
            <div className='Estatetplan-text'>
                ...
                <button className="Estatetplan-button" onClick={() => window.open('https://calendly.com', '_blank')}>
